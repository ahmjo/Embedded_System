...
typedef struct
{
	EXTI_GPIO_Maping_t EXTI_PIN; 		//specifies the EXTI GPIO Maping
	...
	uint8_t			   IRQ_EN;			//Enable or Disable the EXTI IRQ
										//This parameter must be a value of @ref EXTI_IQR_Define

	void (*P_IRQ_CallBack)();			//Set the c func() which will be called once the IRQ Happen
}EXTI_Config_t;
...
//========================================================
//APIs supported by "MCAL_GPIO_Driver"
//========================================================
