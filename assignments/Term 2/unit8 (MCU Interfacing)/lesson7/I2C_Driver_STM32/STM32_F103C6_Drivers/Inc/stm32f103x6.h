...
#define NVIC_IRQ32_I2C1_ER_EN				(NVIC_ISER1 |= (1<<(I2C1_EV_IRQ)))
#define NVIC_IRQ33_I2C2_EV_EN				(NVIC_ISER1 |= (1<<(I2C2_EV_IRQ-32)))
#define NVIC_IRQ34_I2C2_ER_EN				(NVIC_ISER1 |= (1<<(I2C2_ER_IRQ-32)))

#define NVIC_IRQ31_I2C1_EV_Disable 				(NVIC_LCER0 |= (1<<(I2C1_EV_IRQ)))
#define NVIC_IRQ32_I2C1_ER_Disable 				(NVIC_LCER1 |= (1<<(I2C1_EV_IRQ)))
#define NVIC_IRQ33_I2C2_EV_Disable 				(NVIC_LCER1 |= (1<<(I2C2_EV_IRQ-32)))
#define NVIC_IRQ34_I2C2_ER_Disable 				(NVIC_LCER1 |= (1<<(I2C2_ER_IRQ-32)))
